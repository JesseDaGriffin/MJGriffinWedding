        ...
        <td align="center" valign="top" style="padding: 20px;">
          <div class="container" style="background-color: #242424; color: #eaeaea; text-align: left;">
            ...
            <div class="content" style="color: #eaeaea;">
              <h2 style="margin-top: 0; color: #eaeaea;">Hi ${firstName},</h2>
...
export { getAnnouncementEmailTemplate } from '../../utils/emailTemplates';
...
export const getContactEmailTemplate = (name: string, email: string, subject: string, message: string) => {
  ...
  <head>
    <style>
      ...
      .footer { text-align: center; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.1); font-size: 12px; color: rgba(255, 255, 255, 0.5); }
      .detail-row { margin-bottom: 15px; color: #eaeaea; }
        ...
        <td align="center" valign="top" style="padding: 20px;">
          <div class="container" style="background-color: #242424; color: #eaeaea; text-align: left;">
            ...
            <div class="content" style="color: #eaeaea;">
              ...
              <div class="detail-row">
                <span class="label">Email:</span> <a href="mailto:${email}" style="color: #6b8e23; text-decoration: none; font-weight: bold;">${email}</a>
              </div>
              <div class="detail-row">
                <span class="label">Subject:</span> ${subject}
              </div>
              <div class="detail-row" style="margin-top: 20px; padding: 15px; background-color: rgba(0,0,0,0.2); border-radius: 4px; color: #eaeaea;">
                ${message.replace(/\n/g, '<br>')}
              </div>
            </div>
            <div class="footer">
...
export const getRsvpEmailTemplate = (
  ...
  <head>
    <style>
      ...
      .content { padding: 30px 0; color: #eaeaea; }
      .footer { text-align: center; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.1); font-size: 12px; color: rgba(255, 255, 255, 0.5); }
      .detail-row { margin-bottom: 15px; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 10px; color: #eaeaea; }
      ...
      <tr>
        <td align="center" valign="top" style="padding: 20px;">
          <div class="container" style="background-color: #242424; color: #eaeaea; text-align: left;">
            ...
            <div class="header">
              <h1>New Questionnaire Received</h1>
            </div>
            <div class="content" style="color: #eaeaea;">
              <div class="detail-row">
                <span class="label">Guest Name:</span> ${name || 'Unknown'}
              ...
              <div class="detail-row">
                <span class="label">Arrival Date:</span> ${arrivalDate || 'Not provided'}
              </div>
              <div class="detail-row">
                <span class="label">Departure Date:</span> ${departureDate || 'Not provided'}
              </div>
              <div class="detail-row">
                <span class="label">Activities:</span> ${activities && activities.length > 0 ? activities.join(', ') : 'None selected'}
              </div>
              <div class="detail-row">
                <span class="label">Suggestions:</span> ${suggestions || 'None'}
              </div>
            </div>
            <div class="footer">
              <p>This automated message was sent from your wedding website.</p>
