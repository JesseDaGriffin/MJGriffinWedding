                ...
                >
                    ...
                    <div v-if="event.link" class="event-link-wrapper">
                        <NuxtLink
                            ...
                            :to="event.link.to"
                            :class="
                                event.link.class || 'btn btn-secondary btn-sm'
                            "
                        >
                            {{ event.link.text }}
                        </NuxtLink>
                    ...
                    >
                        <li
                            v-for="(activity, aIndex) in event.activities"
                            :key="aIndex"
                            class="activity-item"
                            v-html="activity"
                        ></li>
                    ...
                    <p
                        v-if="event.subDescription"
                        class="event-desc sub-desc"
                        v-html="event.subDescription"
                    ></p>
                </div>
            </div>
        </GlassCard>
...
.timeline-item .timeline-marker {
    ...
    transition:
        transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)
            calc(var(--reveal-delay, 0s) + 0.25s),
