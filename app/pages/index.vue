    ...
    <section class="hero-section">
      <div class="hero-container">
        ...
        <header class="hero-header-text">
          ...
          <p class="wedding-details">March 13th, 2027 &bull; Las Vegas, NV</p>
        ...
        <nav class="hero-nav">
          ...
          <NuxtLink to="/itinerary" class="hero-nav-link">Itinerary</NuxtLink>
          <NuxtLink to="/travel" class="hero-nav-link">Travel</NuxtLink>
          <NuxtLink to="/ceremony" class="hero-nav-link">Ceremony</NuxtLink>
          <NuxtLink to="/registry" class="hero-nav-link">Registry</NuxtLink>
          <NuxtLink to="/contact" class="hero-nav-link">Contact</NuxtLink>
          <NuxtLink to="/questionnaire" class="hero-nav-link">Questionnaire</NuxtLink>
          ...
          <NuxtLink v-else to="/login" class="hero-nav-link hero-nav-link--login">Login</NuxtLink>
        </nav>
        ...
        <div class="couple-photo-container">
          <div class="couple-photo-placeholder">
            <div class="placeholder-overlay">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" class="placeholder-icon">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0ZM18.75 10.5h.008v.008h-.008V10.5Z" />
              </svg>
              <div class="placeholder-text-main">Maddie &amp; Jesse</div>
              <div class="placeholder-text-sub">Insert Portrait Here</div>
            </div>
          </div>
        </div>
