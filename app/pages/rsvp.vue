<template>
  <div class="container section">
    <div class="rsvp-container">
      ...
      <p class="text-center mb-lg">Please let us know if you can make it by March 13th, 2027.</p>
      ...
      <GlassCard v-if="submitted" class="text-center success-message">
        ...
        <button @click="submitted = false" class="btn mt-md">Update RSVP</button>
      </GlassCard>
      ...
      <form v-else @submit.prevent="submitRsvp" class="rsvp-form">
        ...
        <div class="form-group mb-md">
          ...
          <div class="radio-group">
            <label class="radio-label">
              <input type="radio" v-model="form.attending" :value="true" required>
              Joyfully Accept
            </label>
            <label class="radio-label">
        ...
        <div v-if="form.attending" class="attending-details">
          <div class="grid-2">
            <div class="form-group">
              ...
              <input type="number" v-model="form.adults" min="1" max="10" class="form-input" required>
            </div>
            <div class="form-group">
              <label class="form-label">Number of Children</label>
              <input type="number" v-model="form.kids" min="0" max="10" class="form-input" required>
            </div>
          </div>
          ...
          <div class="form-group checkbox-group">
            <label class="checkbox-label">
              <input type="checkbox" v-model="form.events.ceremony">
              <span class="custom-checkbox"></span>
              Ceremony
            </label>
            <label class="checkbox-label">
              <input type="checkbox" v-model="form.events.dinner">
              <span class="custom-checkbox"></span>
              Dinner on Sunday
            </label>
          </div>
        ...
        <div class="form-actions mt-lg">
          <button type="submit" class="btn w-100">Send RSVP</button>
        </div>
        </GlassCard>
      </form>
    </div>
